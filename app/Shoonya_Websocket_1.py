...
ret = api.login(userid=cred['user'], password=cred['pwd'], twoFA=cred['factor2'], vendor_code=cred['vc'],
                api_secret=cred['apikey'], imei=cred['imei'])
# print(ret)
st.write("Login details : ", ret)
...
# print(ret)
st.write("place_order response details : ", ret)
...
st.write("modify_order response details : ", ret)

ret = api.modify_order(exchange='NSE', tradingsymbol='CANBK-EQ', orderno=orderno,
                       newquantity=2, newprice_type='MKT', newprice=0.00)

st.write("modify_order response details 2 : ", ret)
